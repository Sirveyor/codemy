...
def new():
	...
	file_frame.grid(row=0, column=0, columnspan=2, pady=20, padx=20)

def cut():
	hide_menu_frames()
	current_status.set("Cut Status")
	edit_frame.grid(row=0, column=0, columnspan=2, pady=20, padx=20)
...
my_status = Label(root, textvariable=current_status, bd=2, relief="sunken", width=43, anchor=E)
